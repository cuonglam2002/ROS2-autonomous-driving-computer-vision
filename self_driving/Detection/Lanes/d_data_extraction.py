...
def LanePoints(midlane,outerlane,offset):
    ...
    if mid_cnts and outer_cnts:
        ...
        return traj_btm_pt,traj_top_pt,m_rows_btm_pt,o_rows_btm_pt,m_rows_top_pt,o_rows_top_pt
...
def FetchInfoAndDisplay(Mid_lane_edge,Mid_lane,Outer_Lane,frame,Offset_correction):
    ...
    Traj_lowP,Traj_upP,a,b,c,d = LanePoints(Mid_lane,Outer_Lane,Offset_correction)
    ...
    Out_image = cv2.circle(Out_image, a, 3, (255, 0, 0), 4) 
    Out_image = cv2.circle(Out_image, b, 3, (0, 0, 255), 4) 
    Out_image = cv2.circle(Out_image, c, 3, (255, 0, 0), 4) 
    Out_image = cv2.circle(Out_image, d, 3, (0, 0, 255), 4) 
    # Out_image = cv2.resize(Out_image, (600, 400))
