...
# Kích thước hình ảnh gốc (tham chiếu)
Ref_imgWidth = 640
Ref_imgHeight = 480
...
Lane_Extraction_minArea_per = 100 / Frame_pixels
minArea_resized = int(Resize_Framepixels * Lane_Extraction_minArea_per)

BWContourOpen_speed_MaxDist_per = 150 / Ref_imgHeight
MaxDist_resized = int(Resized_height * BWContourOpen_speed_MaxDist_per)


CropHeight = 340 # Required in Camera mounted on top of car 640p
